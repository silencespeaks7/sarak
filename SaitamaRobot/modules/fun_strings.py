...
INSULT_STRINGS = [
    ...
    "When you were born the doctor said: Aww what a treasure and your Mom replied: Yeah, let's bury it.",
    "Take one glass of water And jump on it.",
    "You like Animals....i like you there is no difference🤣.",
    "You're so ugly; when ur mom dropped u off at school she got a fine for littering.",
